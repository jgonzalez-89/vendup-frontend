...
const FAQs = () => (
  <>
    ...
    <Accordion className="m-3" style={{ background: '#212529' }} defaultActiveKey="">
      ...
      <Accordion.Item eventKey="2">
        ...
        <Accordion.Body>
          El tiempo de entrega depende de la ubicación del vendedor y del comprador. Normalmente, el tiempo de entrega oscila entre 3 y 7 días
          hábiles.
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="3">
        ...
        <Accordion.Body>
          En caso de que el artículo que recibas no coincida con la descripción del vendedor, puedes solicitar un reembolso o una devolución en un
          plazo de 14 días desde la recepción del artículo.
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="4">
        <Accordion.Header>¿Cómo puedo contactar al vendedor si tengo preguntas sobre un artículo?</Accordion.Header>
        <Accordion.Body>
          En la página de cada artículo se encuentra un botón de "contactar al vendedor", desde el cual podrás enviar un mensaje directamente al
          vendedor para aclarar tus dudas.
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="5">
        <Accordion.Header>¿Cómo se calculan los costos de envío?</Accordion.Header>
        <Accordion.Body>
          Los costos de envío se calculan automáticamente en función del peso y las dimensiones del paquete, así como la ubicación del vendedor y del
          comprador.
        </Accordion.Body>
      </Accordion.Item>
      <Accordion.Item eventKey="6">
        ...
        <Accordion.Body>
          Puedes cancelar tu pedido en un plazo de 24 horas desde su realización. Después de ese plazo, la cancelación dependerá del vendedor y de sus
      ...
      <Accordion.Item eventKey="7">
        ...
        <Accordion.Body>
          Verificamos la identidad de cada vendedor y supervisamos las transacciones para asegurarnos de que se cumplan nuestras políticas de calidad
          y seguridad.
        </Accordion.Body>
      </Accordion.Item>
      ...
      <Accordion.Item eventKey="9">
        ...
        <Accordion.Body>
          Si tienes algún problema con tu pedido, puedes contactar con nuestro equipo de soporte al cliente para recibir ayuda y resolver el problema
          lo antes posible.
        </Accordion.Body>
      </Accordion.Item>
    </Accordion>
